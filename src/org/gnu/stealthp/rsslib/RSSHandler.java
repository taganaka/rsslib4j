//$Id: RSSHandler.java,v 1.8 2004/09/04 11:58:19 taganaka Exp $
...
public class RSSHandler extends DefaultHandler{
  ...
  private void processSyndicationTags(String qName, String data){
    ...
    if (tagIsEqual(qName,this.SY_BASE_TAG))
      sy.setSyUpdateBase(data);

    if (tagIsEqual(qName,this.SY_FREQ_TAG))
      sy.setSyUpdateFrequency(data);

    if (tagIsEqual(qName,this.SY_PERIOD_TAG))
